...
if (found_app_aliddns()){
	tabtitle[14] = new Array("", "<#menu5_19_1#>");
}
...
if (found_app_koolproxy()){
	if (found_app_adbyby()){
		tablink[10].push("Advanced_koolproxy.asp");
	}else{
	ad_array = new Array("","Advanced_koolproxy.asp");
	tablink[10] = (ad_array);
}
}
