...
#define HAVE_mulsidi3_64bit (TARGET_64BIT && !TARGET_FIX_R4000)
#define HAVE_umulsidi3_64bit (TARGET_64BIT && !TARGET_FIX_R4000)
...
#define HAVE_unspec_callsi (Pmode == SImode)
#define HAVE_unspec_calldi (Pmode == DImode)
...
extern rtx        gen_unspec_callsi                   (rtx, rtx);
extern rtx        gen_unspec_calldi                   (rtx, rtx);
