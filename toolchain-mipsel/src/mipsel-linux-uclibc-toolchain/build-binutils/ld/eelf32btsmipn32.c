...
static bfd_boolean
gldelf32btsmipn32_check_ld_so_conf (const struct bfd_link_needed_list *l,
				       int force)
{
  ...
  if (! initialized)
    {
      ...
      tmppath = concat (ld_sysroot, "/opt/rt-n56u/toolchain-mipsel/toolchain-3.4.x/etc/ld.so.conf",
			(const char *) NULL);
...
gldelf32btsmipn32_after_open (void)
{
  ...
  for (l = needed; l != NULL; l = l->next)
      ...
      for (force = 0; force < 2; force++)
	{
	  ...
	  if (gldelf32btsmipn32_check_ld_so_conf (l, force))
	    break;
...
OUTPUT_ARCH(mips)\n\
ENTRY(__start)\n\
SEARCH_DIR(\"/opt/rt-n56u/toolchain-mipsel/toolchain-3.4.x/mipsel-linux-uclibc/lib32\"); SEARCH_DIR(\"=/usr/local/lib32\"); SEARCH_DIR(\"=/lib32\"); SEARCH_DIR(\"=/usr/lib32\"); SEARCH_DIR(\"=/usr/local/lib\"); SEARCH_DIR(\"=/lib\"); SEARCH_DIR(\"=/usr/lib\");\n\
SECTIONS\n\
{\n\
  /* Read-only sections, merged into text segment: */\n\
